...
1. og 태그(meta 태그)
   ...
   카카오톡으로 링크를 보내면 미리보기로 뜨는 내용을 설정해주는 것! 쉽게 말해서 데이터를 요약해주는 데이터이다. head에 설정해준다. 

   ```html
     <meta property="og:type" content="website">
     <meta property="og:title" content="나현이의 척척 학사 거듭나기">
     <meta property="og:url" content="https://moongchi98.github.io/my_portfolio/">
     <meta property="og:description" content="나현이의 첫 포트폴리오">
   ...
   ![image-20210212235044669](ReadMe.assets/image-20210212235044669.png)
...
2. favicon
   ...
   ![image-20210212235114316](ReadMe.assets/image-20210212235114316.png)

   요로코롬 각각의 사이트들이 logo?이미지가 다 고유하게 있는 걸 알 수 있다. 이거 이름을 favicon이라고 한다! 

   https://www.favicon-generator.org/ 요기서 생성 가능!

   ![image-20210212235412622](ReadMe.assets/image-20210212235412622.png)

   이로코롬 된다! 나중에 포토샵으로 다시 만져야지!~
